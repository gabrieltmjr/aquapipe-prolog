...
% if piece in board
move('3x3'-F-CF-PF/S-CS-PS-Level-Board-CurrentPlayer-PlayerColor-_-PossibleMoves,
        Player-Color-PipeType-PipeNumber-true-SrcRow/SrcCol-n/n-DestRow/DestCol-n/n, 
        NewGameState) :-
    ...
    extract_piece_list('3x3'-F-CF-PF/S-CS-PS-Level-NewBoard-CurrentPlayer-PlayerColor-_-PossibleMoves,
                        Color,
                        PlayerPieces_),
    nth0(Pos, PlayerPieces_, Player-Color-PipeType-PipeNumber-true-SrcRow/SrcCol-n/n, RemainingPieces), % Remove old piece
...
move('3x3'-F-CF-PF/S-CS-PS-Level-Board-CurrentPlayer-PlayerColor-_-PossibleMoves,
        Player-Color-PipeType-PipeNumber-false-n/n-n/n-DestRow/DestCol-n/n, 
        NewGameState) :-
    ...
    extract_piece_list('3x3'-F-CF-PF/S-CS-PS-Level-NewBoard-CurrentPlayer-PlayerColor-_-PossibleMoves,
                        Color,
                        PlayerPieces_),
    nth0(Pos, PlayerPieces_, Player-Color-PipeType-PipeNumber-false-n/n-n/n, RemainingPieces), % Remove old piece
...
choose_move('3x3'-F-CF-PF/S-CS-PS-Level-Board-h-PlayerColor-_-PossibleMoves, Level, h-PlayerColor-PipeType-PipeNumber-InBoard-SrcRow/SrcCol-n/n-DestRow/DestCol-n/n) :-
    repeat,
...
% PC Level 1 - Random
choose_move('3x3'-F-CF-PF/S-CS-PS-random-Board-pc-PlayerColor-_-PossibleMoves, random, Move) :-
...
% PC Level 2 - Greedy
choose_move('3x3'-F-CF-PF/S-CS-PS-greedy-Board-pc-PlayerColor-_-PossibleMoves, greedy, Move) :-
    write('pc makes a greedy move!'), nl,
    evaluate_moves(PlayerColor, '3x3'-F-CF-PF/S-CS-PS-greedy-Board-pc-PlayerColor-_-PossibleMoves, PossibleMoves, [], EvaluatedMoves),
...
valid_move('3x3'-F-CF-PF/S-CS-PS-Level-Board-CurrentPlayer-PlayerColor-PlayerToMove-PossibleMoves,
            _CP-_PC-_PT-_PN-_IB-_SR/_SC-n/n-DestRow/DestCol-n/n) :-
    extract_piece_list('3x3'-F-CF-PF/S-CS-PS-Level-Board-CurrentPlayer-PlayerColor-_-PossibleMoves,
                        PlayerToMove,
                        PlayerPieces_),
    member(_-_-s-_-true-_/_-_/_, PlayerPieces_),
    member(_-_-m-_-true-_/_-_/_, PlayerPieces_),
    member(_-_-l-_-true-_/_-_/_, PlayerPieces_),
    nth0(_, PlayerPieces_, _CP-_PC-_PT-_PN-_IB-_SR/_SC-n/n), % Check all pieces
...
valid_move('3x3'-F-CF-PF/S-CS-PS-Level-Board-CurrentPlayer-PlayerColor-PlayerToMove-PossibleMoves, 
    ...
    extract_piece_list('3x3'-F-CF-PF/S-CS-PS-Level-Board-CurrentPlayer-PlayerColor-_-PossibleMoves,
                        PlayerToMove,
                        PlayerPieces_),
    nth0(_, PlayerPieces_, _CP-_PC-_PT-_PN-false-n/n-n/n), % Get all pieces not in board
    pipe('3x3', _PT, PipeIndex), % Check if empty spot matches piece type
    nth1(DestRow, Board, Row_), % Search for empty spot
    nth1(DestCol, Row_, Col_), % S
    nth1(PipeIndex, Col_, Value), % S
